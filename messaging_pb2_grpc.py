...
class MessageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=messaging__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=messaging__pb2.MessageResponse.FromString,
                _registered_method=True)
...
def add_MessageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=messaging__pb2.SubscribeRequest.FromString,
                    response_serializer=messaging__pb2.MessageResponse.SerializeToString,
            ),
    }
...
class MessageService(object):
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/MessageService/Subscribe',
            messaging__pb2.SubscribeRequest.SerializeToString,
            messaging__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
